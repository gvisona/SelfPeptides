...
learning_rates=(0.000024 0.0000048 0.0000024)
...
--experiment_group "SP_Embedder" --experiment_name "Embeddings_CMT_final_lower_lr_2" \
...
--init_checkpoint "/fast/gvisona/SelfPeptides/outputs/SP_Embedder/Embeddings_CMT_final_lower_lr/2/checkpoints/001_checkpoint.pt" \
